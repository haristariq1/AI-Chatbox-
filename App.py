...
from openai import OpenAI       # To interact with the OpenAI API
import json, os, requests       # To handle JSON, environment vars, and HTTP requests
from pypdf import PdfReader     # To read PDF files
import gradio as gr             # To create a web interface
